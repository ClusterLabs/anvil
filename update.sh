...
required_packages () {
	yum -y install perl-XML-Simple postgresql-server postgresql-plperl postgresql-contrib perl-CGI perl-NetAddr-IP perl-DBD-Pg rsync perl-Log-Journald perl-Net-SSH2 httpd nmap 'perl(Device::SerialPort)' 'perl(Net::Telnet)'
}
